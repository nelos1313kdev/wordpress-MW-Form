...
/**
 * Title: Post Meta
 * Slug: mechanic-car-repair/post-meta
 * Categories: query
 * Keywords: post meta
	...
	<div class="wp-block-columns alignwide has-small-font-size" style="margin-top:var(--wp--preset--spacing--30)">
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group">
				<!-- wp:paragraph -->
				<p>
					<?php esc_html_x( 'Posted', 'Verb to explain the publication status of a post', 'mechanic-car-repair' ); ?>
				</p>
				<!-- /wp:paragraph -->
				...
				<!-- wp:paragraph -->
				<p>
					<?php esc_html_x( 'in', 'Preposition to show the relationship between the post and its categories', 'mechanic-car-repair' ); ?>
				</p>
				<!-- /wp:paragraph -->
			...
			<div class="wp-block-group">
				<!-- wp:paragraph -->
				<p>
					<?php esc_html_x( 'by', 'Preposition to show the relationship between the post and its author', 'mechanic-car-repair' ); ?>
				</p>
				<!-- /wp:paragraph -->
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group">
				<!-- wp:paragraph -->
				<p>
					<?php esc_html_x( 'Tags:', 'Label for a list of post tags', 'mechanic-car-repair' ); ?>
				</p>
				<!-- /wp:paragraph -->
